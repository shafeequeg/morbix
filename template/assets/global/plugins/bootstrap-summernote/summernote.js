...
(function (factory) {
  ...
  var defaults = {
    ...
    options: {
      ...
      iconPrefix: 'fa fa-',         // prefix for css amenity classes
  ...
  var Renderer = function () {
    ...
    /**
     * bootstrap amenity button template
     * @private
    ...
    var tplStatusbar = function () {
      return '<div class="note-resizebar">' +
               '<div class="note-amenity-bar"></div>' +
               '<div class="note-amenity-bar"></div>' +
               '<div class="note-amenity-bar"></div>' +
             '</div>';
    };
     ...
     * @return {function(iconClass, options=):string} return.iconButton {@link #tplIconButton function to make amenity button}
   ...
   *            // make amenity button by template function
