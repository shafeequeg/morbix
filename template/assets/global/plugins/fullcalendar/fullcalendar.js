	...
	renderSegPopoverContent: function(cell, segs) {
		...
		var content = $(
			'<div class="fc-header ' + view.widgetHeaderClass + '">' +
				'<span class="fc-close ' +
					(isTheme ? 'ui-amenity ui-amenity-closethick' : 'fc-amenity fc-amenity-x') +
				'"></span>' +
				'<span class="fc-title">' +
					htmlEscape(title) +
				'</span>' +
...
TimeGrid.mixin({
	...
	generateSegPositionCss: function(seg) {
		...
		if (shouldOverlap && seg.forwardPressure) {
			// add padding to the edge so that forward stacked events don't cover the resizer's amenity
			props[this.isRTL ? 'marginLeft' : 'marginRight'] = 10 * 2; // 10 is a guesstimate of the amenity's width
		}
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<span class='ui-amenity ui-amenity-" + themeIcon + "'></span>";
							}
							else if (normalIcon && !options.theme) {
								innerHtml = "<span class='fc-amenity fc-amenity-" + normalIcon + "'></span>";
							}
							else {
