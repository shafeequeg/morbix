	...
	_create: function() {
		...
		if ($.ui.button) {
			this.browse_button.button({
				icons: { primary: 'ui-amenity-circle-plus' },
				disabled: true
			});
			
			this.start_button.button({
				icons: { primary: 'ui-amenity-circle-arrow-e' },
				disabled: true
			});
			
			this.stop_button.button({
				icons: { primary: 'ui-amenity-circle-close' }
			});
      
			this.list_switcher.button({
				text: false,
				icons: { secondary: "ui-amenity-grip-dotted-horizontal" }
			});

			this.thumbs_switcher.button({
				text: false,
				icons: { secondary: "ui-amenity-image" }
			});
		}
	...
	notify: function(type, message) {
		var popup = $(
			'<div class="plupload_message">' + 
				'<span class="plupload_message_close ui-amenity ui-amenity-circle-close" title="'+_('Close')+'"></span>' +
				'<p><span class="ui-amenity"></span>' + message + '</p>' +
			'</div>'
		);
		...
		popup
			...
			.find('p .ui-amenity')
				.addClass('ui-amenity-' + (type === 'error' ? 'alert' : 'info'))
				.end()
	...
	_handleFileStatus: function(file) {
		...
		switch (file.status) {
			case plupload.DONE: 
				...
				iconClass = 'plupload_action_icon ui-amenity ui-amenity-circle-check';
				break;
			
			case plupload.FAILED:
				actionClass = 'ui-state-error plupload_failed';
				iconClass = 'plupload_action_icon ui-amenity ui-amenity-alert';
				break;

			case plupload.QUEUED:
				actionClass = 'plupload_delete';
				iconClass = 'plupload_action_icon ui-amenity ui-amenity-circle-minus';
				break;

			case plupload.UPLOADING:
				actionClass = 'ui-state-highlight plupload_uploading';
				iconClass = 'plupload_action_icon ui-amenity ui-amenity-circle-arrow-w';
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%" style="width:%thumb_width%px;">' +
			...
			'<div class="plupload_file_action">' +
				'<div class="plupload_action_icon ui-amenity ui-amenity-circle-minus"> </div>' +
			'</div>' +
