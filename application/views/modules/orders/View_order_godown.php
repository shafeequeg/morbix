                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1">
                            ...
                            foreach ($result as $r) {
                                ...
                                {$status="<span class='label label-primary ' style='margin-bottom: 5px;margin-right: 5px' >Shipped</span>";}
                                else
                                ...
                                <tr>
                                   ...
                                   <a id="deletebtn" class="btn-icon-only btn btn-primary "  href="#delete" data-toggle="modal"><i class="fa fa-plus"></i></a>
                                </td>
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="alert alert-block alert-danger fade in">
                        ...
                        <p> Are You Sure to Change  this Shipped ?. </p>
...
<script>
    ...
    //     $("#deleteform").attr('action', '<?php echo base_url().$controller_directory ?>/orders/shipped');
    // });
