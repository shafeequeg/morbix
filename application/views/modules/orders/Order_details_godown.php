...
<div class="row">
    <div class="col-md-12">
        <div class="invoice-content-2 ">
            ...
            <form action="<?php echo base_url() .$controller_directory ?>/orders/shipped" method="post">
            <input type="hidden" name="order_id" value="<?= $result1->order_id ?>" >
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-lg green-haze hidden-print uppercase print-btn">Make as Shipped</button>
                </div>
            </div>
            </form>
        </div>  
