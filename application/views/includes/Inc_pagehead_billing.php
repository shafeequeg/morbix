                ...
                ?>
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                ...
                                foreach($orders_result as $r11):
                                    ...
                                    ?>
                                    <li>
                                        <a href="<?php echo base_url() ?>billing/orders/invoice/<?php echo $r11['order_id']; ?>">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="<?php echo base_url()?>billing/user/profile/<?php echo $this->session->userdata('login_id')?>">
                                    <i class="icon-user"></i> My Profile </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url()?>billing/user/change_password">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul id="side_bar" class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                <li class="nav-item start " id="dashboard_menu">
                    <a href="<?php echo base_url()?>master/dashboard" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                ...
                <li class="nav-item  " id="order_menu">
                    ...
                    <li class="nav-item  " id="order_menu2">
                            <a href="<?php echo base_url()?>billing/orders/create_order" class="nav-link ">
                                <span class="title">Create New Order</span>
                            </a>
                        </li>
                        <li class="nav-item  " id="order_menu2">
                            <a href="<?php echo base_url()?>billing/orders" class="nav-link ">
                ...
                <li class="nav-item  " id="account_menu">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  " id="account_menu1">
                            <a href="<?php echo base_url()?>master/user/change_password" class="nav-link ">
                                <span class="title">Change Password</span>
                            </a>
                        </li>
                        <li class="nav-item  " id="account_menu2">
                            <a href="<?php echo base_url()?>master/user/profile/<?php echo $this->session->userdata('login_id')?>" class="nav-link ">
