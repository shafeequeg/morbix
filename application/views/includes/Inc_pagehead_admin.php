...
<!--                    </li>-->
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="<?php echo base_url()?>admin/user/profile/<?php echo $this->session->userdata('login_id')?>">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul id="side_bar" class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item  " id="stock_menu">
                    <a href="<?php echo base_url()?>admin/stock" class="nav-link nav-toggle">
                ...
                <li class="nav-item  " id="data_menu">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  " id="data_menu1">
                            <a href="<?php echo base_url()?>admin/batch" class="nav-link ">
                ...
                <li class="nav-item  " id="account_menu">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  " id="account_menu1">
                            <a href="<?php echo base_url()?>admin/user/change_password" class="nav-link ">
                                <span class="title">Change Password</span>
                            </a>
                        </li>
                        <li class="nav-item  " id="account_menu2">
                            <a href="<?php echo base_url()?>admin/user/profile/<?php echo $this->session->userdata('login_id')?>" class="nav-link ">
