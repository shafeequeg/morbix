                ...
                ?>
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                ...
                                foreach($orders_result as $r11):
                                    ...
                                    ?>
                                    <li>
                                        <a href="<?php echo base_url() ?>godown/orders/order_details/<?php echo $r11['order_id']; ?>">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <a href="<?php echo base_url()?>godown/user/profile/<?php echo $this->session->userdata('login_id')?>">
                                    <i class="icon-user"></i> My Profile </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url()?>godown/user/change_password">
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul id="side_bar" class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item  " id="order_menu">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  " id="order_menu1">
                            <a href="<?php echo base_url()?>godown/orders/create_order" class="nav-link ">
                                <span class="title">Order</span>
                            </a>
                        </li>
                        
                        <li class="nav-item  " id="order_menu2">
                            <a href="<?php echo base_url()?>godown/orders" class="nav-link ">
                ...
                <li class="nav-item  " id="order_menu">
                    <a href="<?php echo base_url()?>godown/stock" class="nav-link">
                        <i class="fa fa-edit"></i>
                ...
                <li class="nav-item  " id="order_menu">
                    <a href="<?php echo base_url()?>godown/customer" class="nav-link">
                        <i class="fa fa-edit"></i>
                ...
                <li class="nav-item  " id="data_menu">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  " id="data_menu1">
                            <a href="<?php echo base_url()?>godown/batch" class="nav-link ">
                                <span class="title">Manage Batch</span>
                            </a>
                        </li>
                        <li class="nav-item  " id="data_menu2">
                            <a href="<?php echo base_url()?>godown/item" class="nav-link ">
