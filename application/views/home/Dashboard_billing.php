    ...
    <?php $this->view("includes/Inc_pagehead".$page_head_file_suffix);?>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                        <a href="<?php echo base_url()?>billing/dashboard">Home</a>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green bold uppercase">Project Cost</span>
                        ...
                        <div class="portlet-body">
                            <div id="dashboard_amchart_5" class="chart">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red-sunglo bold uppercase">Production Status</span>
                                <span class="caption-helper">Daily stats...</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div id="dashboard_amchart_6" class="chart">
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                ...
                                <a href="#"> <div class="tile bg-green " >
                                        ...
                                        <div class="tile-object">
                                            <div class="name"> Product Stock </div>
                                            <div class="number">  </div>
                                        </div>
                                    </div></a>
                                ...
                                <a href="#"> <div class="tile bg-yellow-gold">
                                        <div class="tile-body">
                                            <i class="fa fa-paw"></i>
                                        </div>
                                        <div class="tile-object">
